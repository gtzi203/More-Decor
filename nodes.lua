...
more_decor.register_lamp("small_factory", {description = S("Small Factory Lamp"), texture = "more_decor_small_factory_lamp.png", drawtype = "mesh", mesh = "more_decor_small_factory_lamp.obj", node_box = {{-0.4375, 0.4375, -0.1875, 0.4375, 0.5000, 0.1875}}, light_source = 14, sound = {name = "more_decor_light_humm", length = 1}})
more_decor.register_lamp("medium_factory", {description = S("Medium Factory Lamp"), texture = "more_decor_medium_factory_lamp.png", drawtype = "mesh", mesh = "more_decor_medium_factory_lamp.obj", node_box = {{-1.438, 0.4375, -0.1875, 1.438, 0.5000, 0.1875}}, light_source = 14, sound = {name = "more_decor_light_humm", length = 1}})
more_decor.register_lamp("large_factory", {description = S("Large Factory Lamp"), texture = "more_decor_large_factory_lamp.png", drawtype = "mesh", mesh = "more_decor_large_factory_lamp.obj", node_box = {{-2.438, 0.4375, -0.1875, 2.438, 0.5000, 0.1875}}, light_source = 14, sound = {name = "more_decor_light_humm", length = 1}})
more_decor.register_lamp("small_old_factory", {description = S("Small Old Factory Lamp"), texture = "more_decor_small_old_factory_lamp.png", drawtype = "mesh", mesh = "more_decor_small_factory_lamp.obj", node_box = {{-0.4375, 0.4375, -0.1875, 0.4375, 0.5000, 0.1875}}, light_source = 9, sound = {name = "more_decor_light_humm", length = 1}, flicker = {time_min = 17.0, time_max = 40.0}})
more_decor.register_lamp("medium_old_factory", {description = S("Medium Old Factory Lamp"), texture = "more_decor_medium_old_factory_lamp.png", drawtype = "mesh", mesh = "more_decor_medium_factory_lamp.obj", node_box = {{-1.438, 0.4375, -0.1875, 1.438, 0.5000, 0.1875}}, light_source = 9, sound = {name = "more_decor_light_humm", length = 1}, flicker = {time_min = 17.0, time_max = 40.0}})
more_decor.register_lamp("large_old_factory", {description = S("Large Old Factory Lamp"), texture = "more_decor_large_old_factory_lamp.png", drawtype = "mesh", mesh = "more_decor_large_factory_lamp.obj", node_box = {{-2.438, 0.4375, -0.1875, 2.438, 0.5000, 0.1875}}, light_source = 9, sound = {name = "more_decor_light_humm", length = 1}, flicker = {time_min = 17.0, time_max = 40.0}})
